...
exports.AddressController = exports.UserController = void 0;
...
let UserController = class UserController {
    ...
    async createAddress(id, createAddressDto) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Create address for user by ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: 'number' }),
